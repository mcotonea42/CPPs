...
/*   Updated: 2025/07/01 23:17:39 by melvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(){
    ...
    // std::cout << std::endl;
    // {
    //     std::cout << "Instantiating an abstract class" << std::endl;
    //     std::cout << std::endl;
    //     std::cout << "An abstract class is not instantiable in the following cases:" << std::endl;
    //     AAnimal a;
